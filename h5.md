...
Nyt kun oli ns. uusi ympäristön käynnisssä niin kokeilin uudelleen kloonata gitistä Responderia ja sehän meni ilman ongelmia tällä kertaa:

![image](https://github.com/user-attachments/assets/1c3e86d5-078d-4eaa-b30f-56566244e19c)

Tämän jäkeen vaihdoin "/Responder" hakemistoon ja varmistin conffin kuuntelevan SMB pyyntöjä.
...
Kahdeksannessa kohdassa kysyttiin työäkalun nimeä, josta käytetään lyhennettä "john", ja tähän on helppo vastata kurssin aikasemman tehtävän perusteella, eli vastaus on `John the Ripper`.
...
Seuraavaksi laitetaan john työskentelmään komennolla `john -w=/usr/share/wordlists/rockyou.txt hash.txt`
