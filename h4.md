...
Seuraavaksi kokeilin selvittää tiivisteen komenolla `7z2john secure.7z >secure.7z.hash`, jonka jälkeen lähdin purkamaan salasanaa komennolla `john secure.7z.hash`
